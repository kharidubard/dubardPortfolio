    ...
    ></iframe>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            <div className="bg-gray-200 w-full h-[360px] rounded-md shadow-md">
              {/* First Image */}
              <img
                src="/src/assets/projectFiles/brandingFiles/dcBranding/HowtoAceYourInterview.webp"
                className="w-full h-full object-contain rounded-md"
            ...
            <div className="bg-gray-200 w-full h-[360px] rounded-md shadow-md">
              {/* Second Image */}
              <img
                src="/src/assets/projectFiles/brandingFiles/dcBranding/FigmaWorkshop.webp"
                className="w-full h-full object-contain rounded-md"
            ...
            <div className="bg-gray-200 w-full h-[360px] rounded-md shadow-md">
              {/* Third Image */}
              <img
                src="/src/assets/projectFiles/brandingFiles/dcBranding/FrozenYogurtSocial.webp"
                className="w-full h-full object-contain rounded-md"
            ...
            <div className="bg-gray-200 w-full h-[360px] rounded-md shadow-md">
              {/* Fourth Image */}
              <img
                src="/src/assets/projectFiles/brandingFiles/dcBranding/GameKnight.webp"
                className="w-full h-full object-contain rounded-md"
            ...
            <div className="bg-gray-200 w-full h-[360px] rounded-md shadow-md">
              {/* Fifth Image */}
              <img
                src="/src/assets/projectFiles/brandingFiles/dcBranding/JavaScriptWorkshop.webp"
                className="w-full h-full object-contain rounded-md"
