    ...
    <div className="App py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-lg mx-auto">
          <h2 className="text-[34px] md:text-3xl font-bold text-center text-white mb-4 md:mb-6 flex items-center justify-center">
          ...
          <div className="flex flex-col items-center mt-6 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <a
                ...
                target="_blank"
                className="text-white font-bold hover:text-gray-300 text-md"
              >
                Email
              </a>
            </div>
