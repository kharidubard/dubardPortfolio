  ...
  return (
    <>
      <header
        ...
        <div className="max-w-[110rem] w-full flex justify-between">
          ...
          <nav
            ...
            } yo:translate-x-0 fixed inset-0 z-40 h-full overflow-auto md:relative md:h-auto md:overflow-visible md:opacity-100 md:translate-x-0 transition-all duration-300`}>
