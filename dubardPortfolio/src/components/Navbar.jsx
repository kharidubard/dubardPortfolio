          ...
          <div className="z-50 flex md:hidden">
            ...
            <nav className={`${isActive ? "yo:opacity-1 yo:translate-x-0" : "yo:opacity-0 yo:translate-x-[100vw]"} yo:translate-x-0 fixed inset-0 z-40 h-full overflow-auto md:relative md:h-auto md:overflow-visible`}>
              <ul className="bg-black md:bg-transparent flex font-bold flex-col justify-center items-center h-full w-full  gap-5 md:flex-row md:justify-start  lg:flex-row">                
                ...
                <a onClick={toggleStyles} href="#AboutUs" className="block lg:mt-0 text-white text-[1.6rem] hover:text-primaryLightBlue mr-4"> About Me</a>
                <a href="mailto:kharidubard@gmail.com" target="_blank" rel="noreferrer"  className="block lg:mt-0 text-white text-[1.6rem] hover:text-primaryLightBlue mr-4"> Contact </a>
                <a href="#" className="inline-block text-sm px-4 py-2 leading-none border rounded-2xl text-white text-[1.6rem] border-white hover:border-transparent hover:text-white hover:bg-primaryLightBlue lg:mt-0">
                  My Resume
                </a>
              </ul>
            </nav>
